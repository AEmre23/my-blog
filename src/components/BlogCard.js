...
const BlogCard = ({ post }) => {
  return (
    <Link href={`/Posts/${post.id}`}>
      <div className="w-80 flex flex-col gap-2 border-2 font-rubik cursor-pointer duration-300 hover:scale-105 shadow-[rgba(50,_50,_93,_0.25)_0px_13px_27px_-5px,_rgba(0,_0,_0,_0.3)_0px_8px_16px_-8px] rounded-xl bg-white p-4">
