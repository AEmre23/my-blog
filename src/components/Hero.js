...
const Hero = () => {
  return (
    <main>
      <div className="min-h-[calc(100vh_-_74px)] w-full bg-[url('../assets/bg.png')] bg-[size:100%_100%] bg-newbg bg-no-repeat relative font-rubik">
        <div className="absolute left-[8%] top-[12%] mobile:top-[6%] mobile:left-[6%]">
          <h1 className="text-5xl font-bold">What's on your mind?</h1>
          <h2 className= "text-4xl font-medium ml-10 mt-3 mobile:ml-0">Write it here!</h2>
        </div>
      ...
      <div className="relative h-screen w-full bg-[url('../assets/bgr.png')] bg-[size:100%_100%] bg-no-repeat">
        <p className="text-black z-50">SDADASDAS</p>
      </div>  
    </main>
  )
}
